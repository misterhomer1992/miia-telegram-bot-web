...
export const meta = pageMeta("dataSecurity");
...
export default function DataSecurity() {
  ...
  const { t } = useT();
  const sections = t("pages.dataSecurity.sections", { returnObjects: true }) as Section[];
  return (
    <PageLayout
      locale={locale}
      title={t("pages.dataSecurity.title")}
      lede={t("pages.dataSecurity.lede")}
    >
      {sections.map((s, i) => (
